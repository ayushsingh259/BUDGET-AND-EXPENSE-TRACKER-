...
Functional Modules
Transaction Management: add, view, search, and delete income or expense records.
Budget Management: set a monthly budget and compare it with total expenses.
Reporting and Summary: calculate totals, balance, category-wise spending, and budget warnings.
Technologies Used
Java 11 or later
...
Testing
The project uses manual console test cases because the requested project has no build tool or external testing library. See docs/testing.md for the test plan and results that should be checked after each run.
